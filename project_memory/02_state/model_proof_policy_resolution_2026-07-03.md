...
- Regenerated simulated buy-selection classification: `26` rows, `0` Buy predictions, `26` profitable actuals, with `unresolved_policy_rows=11` and `stored_action_fallback_rows=0`.
