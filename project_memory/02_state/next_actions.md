...
22. The next coverage-expansion step after the new tag batch is curves, not more generic tag sprawl. Camry Altise `ASV50R` is now saved; next priority order is Mazda CX-5 Maxx Sport diesel `KE`, Hyundai ix35 `LM`, then Hyundai Getz `TB`.
