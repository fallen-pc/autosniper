...
20. Continue the profit/valuation audit from the next remaining decision surfaces after the conservative-margin and top-buy/bid-basis fixes: hard-max safety wording, max-bid recommendation consistency, and any stale stored valuation rows that still need recomputation.
