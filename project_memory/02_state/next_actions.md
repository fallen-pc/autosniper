...
22. The next coverage-expansion step after the new tag batch is curves, not more generic tag sprawl. Prioritize saved curves in this order unless the live mix changes materially: Camry Altise `ASV50R`, Mazda CX-5 Maxx Sport diesel `KE`, Hyundai ix35 `LM`, then Hyundai Getz `TB`.
