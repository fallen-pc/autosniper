...
- The page uses Streamlit's current `width="stretch"` API for tables and downloads so production rendering does not emit the retired `use_container_width` warning.
