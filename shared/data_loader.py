...
DATASET_PATHS: dict[str, Path] = {
    ...
    "vehicle_state.csv": Path("scrapers") / "vehicle_state.csv",
    ...
    "sold_price_pending.csv": Path("scrapers") / "sold_price_pending.csv",
    ...
    "pipeline_exclusions.csv": Path("scrapers") / "pipeline_exclusions.csv",
