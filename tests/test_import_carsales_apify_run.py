...
def test_normalize_items_preserves_zero_odometer_and_source_fuel():
    normalized = normalize_items(
        [
            {
                "adId": "SSE-AD-ZERO",
...
def test_merge_output_collapses_repeated_unidentified_content(tmp_path: Path):
    imported = normalize_items(
        [
            {"title": "Same", "make": "Nissan", "model": "Pulsar", "year": 2013},
            {"title": "Same", "make": "Nissan", "model": "Pulsar", "year": 2013},
        ]
    )
...
def test_merge_output_deduplicates_each_identity_and_parses_timestamp_offsets(tmp_path: Path):
    output_path = tmp_path / "carsales_apify_listings.csv"
    existing = normalize_items(
        [
            {
                "runId": "old",
                "adId": "SSE-AD-1",
                "canonicalUrl": "https://example.test/old-url",
                "title": "Old by ad",
                "scrapedAt": "2026-08-10T12:00:00+10:00",
            },
            {
                "runId": "old",
                "adId": "SSE-AD-OLD",
                "canonicalUrl": "https://example.test/shared-url",
                "title": "Old by URL",
                "scrapedAt": "2026-08-10T02:30:00Z",
            },
        ]
    )
        ...
        [
            {
                "runId": "new",
                "adId": "SSE-AD-1",
                "canonicalUrl": "https://example.test/new-url",
                "title": "New by ad",
            ...
            },
            {
                ...
                "canonicalUrl": "https://example.test/shared-url",
                "title": "New by URL",
                "scrapedAt": "2026-08-10T03:30:00Z",
            },
        ]
    )
    ...
    assert set(merged["title"]) == {"New by ad", "New by URL"}
