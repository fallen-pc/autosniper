...
| `scripts/check_commit_hygiene.py` | changed_this_wave | Tiny wrapper-identity cleanup complete in current curve mini-wave; stop here for now | low-medium | current working tree + direct file read + py_compile check | Added compatibility-wrapper docstring; behavior unchanged |
