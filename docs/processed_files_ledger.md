...
| `ops/` | historically_active | Real package split exists in sandbox; checkpointed and later audit-validated as a real package lane, not empty scaffolding | high | current sandbox working tree + direct package listing + wrapper reads + post-checkpoint audit | Directionally coherent package split; still curve-adjacent and worth caution |
| `scripts/active_monitor.py` | historically_active | Structural-refactor lane: now appears to be compatibility shim into `ops.active_monitor` | medium-high | current sandbox working tree + direct file read + diff stat | Wrapper-style forwarding script |
| `scripts/analyze_bid_history.py` | historically_active | Structural-refactor lane likely active; audit actual `ops/` implementation before checkpointing | medium-high | current sandbox working tree + diff stat | Appears to be part of package migration/wrapper set |
...
| `scripts/outcome_tracking.py` | historically_active | Structural-refactor lane likely active; audit actual `ops/` implementation before checkpointing | medium-high | current sandbox working tree + diff stat | Appears to be part of package migration/wrapper set |
| `scripts/render_curve_images.py` | historically_active | Structural-refactor lane likely active; audit actual `ops/` implementation before checkpointing | medium-high | current sandbox working tree + diff stat | Appears to be part of package migration/wrapper set |
