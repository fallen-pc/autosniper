...
| `governance/` | historically_active | Real package split exists in sandbox; appears paired with script-wrapper compatibility layer | high | current sandbox working tree + direct package listing + wrapper reads | New governance package present but not yet checkpointed |
...
| `scripts/check_commit_hygiene.py` | historically_active | Structural-refactor lane: compatibility shim into governance package | medium | current sandbox working tree + direct file read + diff stat | Wrapper-style forwarding script |
| `scripts/curve_coverage_report.py` | historically_active | Structural-refactor lane: compatibility shim into governance package | medium | current sandbox working tree + direct file read + diff stat | Wrapper-style forwarding script |
| `scripts/curve_validator.py` | historically_active | Structural-refactor lane: compatibility shim into governance package | medium-high | current sandbox working tree + direct file read + diff stat | Wrapper-style forwarding script |
| `scripts/governance_checks.py` | historically_active | Structural-refactor lane: compatibility shim into governance package | medium-high | current sandbox working tree + prior direct file read + diff stat | Wrapper-style forwarding script |
...
| `scripts/readiness_smoke.py` | historically_active | Structural-refactor lane: compatibility shim into governance package | medium | current sandbox working tree + direct file read + diff stat | Wrapper-style forwarding script |
