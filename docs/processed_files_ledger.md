...
| `jobs/` | historically_active | Real package split exists in sandbox; appears paired with script-wrapper compatibility layer | high | current sandbox working tree + direct package listing + wrapper reads | New jobs package present but not yet checkpointed |
| `ops/` | historically_active | Real package split exists in sandbox; appears paired with script-wrapper compatibility layer | high | current sandbox working tree + direct package listing + wrapper reads | New ops package present but not yet checkpointed |
