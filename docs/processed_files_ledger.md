...
| `scripts/check_commit_hygiene.py` | historically_active | Structural-refactor lane: audit-validated compatibility shim into governance package | medium | current sandbox working tree + direct file read + diff stat + governance-lane audit | Wrapper-style forwarding script; CLI structure preserved |
| `scripts/curve_coverage_report.py` | historically_active | Structural-refactor lane: audit-validated compatibility shim into governance package | medium | current sandbox working tree + direct file read + diff stat + governance-lane audit | Wrapper-style forwarding script; package module still depends on `scripts.atomic_csv` |
| `scripts/curve_validator.py` | historically_active | Structural-refactor lane: audit-validated compatibility shim into governance package | medium-high | current sandbox working tree + direct file read + diff stat + governance-lane audit | Wrapper-style forwarding script; no obvious deferred-core reach-back found |
