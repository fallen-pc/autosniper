...
| `tests/test_generate_curve_candidates.py` | changed_this_wave | Tiny regression-test follow-up complete; ready for checkpoint | low | current working tree + direct file read + py_compile check | Added narrow test covering stable, duplicate-free `review_reason` output |
| `tests/test_governance.py` | changed_this_wave | Tiny regression-test follow-up complete; ready for checkpoint | low | current working tree + direct file read + py_compile check | Added narrow test covering allowlist matching after path normalization |
